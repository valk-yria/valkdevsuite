...
local widgetButton = toolbar:CreateButton(
	"Map Tools",
	"Activates toolbar that assists in map development, etc.",
	assets.pluginButtonImage
)
...
do
	local funcs = {
		...
		{
			waypointTool:GetCurrentTransform(
				textBoxes[4],
				textBoxes[5],
				textBoxes[6],
				textBoxes[7],
...
do
	local function ChangeColor()
		local themeCheck = settings().Studio.Theme.Name == "Dark" and Color3.new(46 / 255, 46 / 255, 46 / 255)
			or Color3.new(255 / 255, 255 / 255, 255 / 255)
